...
<body>
 ...
 <ul id='dropdown1' class='dropdown-content'>
    @foreach($categoriasMenu as $categoriaM)
        <li><a href="{{route('gerencial.categoria', $categoriaM->id)}}">{{$categoriaM->nome}}</a></li>
    @endforeach
    ...
    <nav class="red">
        <div class="nav-wrapper container   ">
          ...
          <ul id="nav-mobile" class="left">
            <li><a href="{{route('gerencial.index')}}">Home</a></li>
            <li><a href="" class="dropdown-trigger"  data-target="dropdown1"> Categorias <i class="material-icons right">expand_more</i></a></li>
            <li><a href="{{ route('gerencial.carrinho')}}">Carrinho<span class="new badge blue" data-badge-caption="">{{\Cart::getContent()->count()}}</span></a></li>
          </ul>
